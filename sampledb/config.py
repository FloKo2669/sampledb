...
# other settings
ONLY_ADMINS_CAN_MANAGE_LOCATIONS = True
ONLY_ADMINS_CAN_CREATE_GROUPS = True
ONLY_ADMINS_CAN_DELETE_GROUPS = True
ONLY_ADMINS_CAN_CREATE_PROJECTS = True
ONLY_ADMINS_CAN_DELETE_PROJECTS = True
ONLY_ADMINS_CAN_MANAGE_GROUP_CATEGORIES = True

DISABLE_USE_IN_MEASUREMENT = True
